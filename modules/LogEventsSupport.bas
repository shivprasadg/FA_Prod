Attribute VB_Name = "LogEventsSupport"
 Option Explicit
 Option Compare Text
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' modInsertProcNames
...
End Sub
    ...
    '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ' EndOfCommentOfProc
    ' This returns the line number of the last comment line in a comment block that
    ' IMMEDIATELY follows the procedure declaration. For example, with the following
    ' code
    ...
    '       '''''''''''''''''''''''''''''''''''' END COMMENT BLOCK
    '
    ' the function will return the line number of "END COMMENT BLOCK". There must be
