Operation =1
Option =0
Where ="(((CofA_Report_X.SchID)=[Forms]![BulkChange_Form]![ScheduleList]))"
Begin InputTables
    Name ="CofA_Report_X"
    Name ="Locations"
    Name ="Locations"
...
Begin
    ...
    End
    Begin
        dbText "Name" ="CofA_Report_X.Units.PRINTCOFA"
        dbLong "AggregateType" ="-1"
    End
    Begin
    ...
    End
    Begin
        dbText "Name" ="CofA_Report_X.Units.UnitTransDays"
        dbLong "AggregateType" ="-1"
    End
    Begin
    ...
    End
    Begin
        dbText "Name" ="CofA_Report_X.Expr1036"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="CofA_Report_X.LookUp_UnitDesc.DescriptionLong"
        dbLong "AggregateType" ="-1"
    End
    Begin
    ...
    End
    Begin
        dbText "Name" ="AmendmentNO"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="AmendmentDate"
        dbLong "AggregateType" ="-1"
    End
    Begin
    ...
    End
    Begin
        dbText "Name" ="CofA_Report_X.LeaseTermPrimary"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="Expr1"
    ...
    End
    Begin
        dbText "Name" ="CofA_Report_X.SchID"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="CofA_Report_X.Expr1035"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="CofA_Report_X.Expr1042"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="CofA_Report_X.SchGrp.LeaseTermPrimary"
        dbLong "AggregateType" ="-1"
    End
End
Begin
