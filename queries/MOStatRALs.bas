...
dbMemo "Filter" ="(([MOStatRALs].[clientCompanyName]<>\"Reinhart Transportation, LLC\" Or [MOStatR"
    "ALs].[clientCompanyName] IS Null)) AND ([MOStatRALs].[clientCompanyName]<>\"Sout"
    "hern Wine & Spirits of America, Inc.\" Or [MOStatRALs].[clientCompanyName] IS Nu"
    "ll)"
Begin
    Begin
