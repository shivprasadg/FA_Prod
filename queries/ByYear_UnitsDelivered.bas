Operation =1
Option =0
Where ="(((vw_SixKeys.ActualDeliveryDate)>='1/1/' & [AskYear] And (vw_SixKeys.ActualDeli"
    "veryDate)<'12/31/' & [AskYear]) AND ((vw_SixKeys.MLOrig)=\"FA\"))"
Begin InputTables
    Name ="vw_SixKeys"
End
Begin OutputColumns
...
Begin
    ...
    End
    Begin
        dbText "Name" ="MaxOfActualDeliveryDate"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="FirstDelivered"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="LastDelivered"
        dbLong "AggregateType" ="-1"
    End
End
Begin
