Operation =4
Option =0
Where ="(((Units.unitstatus)=\"R\" Or (Units.unitstatus)=\"PS\") And ((Rmkt.BuyerRef)=fo"
    "rms!ReMarketInvoiceManager!buyerref) And ((Rmkt.InvoicePaidDate) Is Not Null) An"
    "d ((Rmkt.InvoiceRequestDate)=forms!ReMarketInvoiceManager!reqdt))"
Begin InputTables
    Name ="Units"
    Name ="Rmkt"
    Name ="Clients"
