SELECT
  ...
  )& [Locations_1].[LCity] & ", " & [Locations_1].[LState] & " " & Left([Locations_1].[LZip], 5)& "-" & Right([Locations_1].[LZip], 4) AS BillToAddress,
  ...
  IIf(
    ...
    0,
    [ActiveRent] + IIf(
      [unittaxexempt] =-1, 0, [locations].[LTaxRate] * [ActiveRent]
    )+ Nz([SGrpFSLPmt], 0)
  ) AS LineTot,
...
FROM
  ...
  LEFT JOIN ExitOptionsActiveRent ON Units.UnitID = ExitOptionsActiveRent.UnitID
GROUP BY
  Clients_1.clientID,
  Schedule.SchID,
  Schedule.SchNo,
  ...
  [Locations_1].[LocationStreet] & Chr(13)& Chr(10)& [Locations_1].[LAddrLine1] & Chr(13)& Chr(10)& IIf(
    ...
    Null,
    [Locations_1].[LAddrLine2] & Chr(13)& Chr(10)
  )& [Locations_1].[LCity] & ", " & [Locations_1].[LState] & " " & Left([Locations_1].[LZip], 5)& "-" & Right([Locations_1].[LZip], 4),
  Locations_1.LCity,
  Locations_1.LState,
  Locations_1.LZip,
