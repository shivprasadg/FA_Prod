Operation =1
Option =0
Having ="(((MstrLease.MLOrig)=\"fa\") AND ((SchGrp.BLCD) Is Null)) OR (((MstrLease.MLOrig"
    ")=\"fa\") AND ((SchGrp.BLCD) Is Null) AND ((SchGrp.sgrpfaid)=\"13-620\")) OR ((("
    "MstrLease.MLOrig)=\"fa\") AND ((SchGrp.BLCD) Is Null) AND ((Units.unitfaid)=\"13"
    "-620\"))"
Begin InputTables
    Name ="Clients"
    Name ="MstrLease"
