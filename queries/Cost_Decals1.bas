dbMemo "SQL" ="SELECT Cost_DecalVendor1.AssetId, Vendors.VendorName AS DecalVendor1, ChildParts"
    ...
    "N ChildParts ON (Cost_DecalVendor1.DecalVendor = ChildParts.ChildVendorREF) AND "
    "(Cost_DecalVendor1.AssetId = ChildParts.UnitREF)) INNER JOIN Vendors ON Cost_Dec"
