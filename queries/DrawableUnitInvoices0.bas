dbMemo "SQL" ="SELECT Vendors.VendorSNm AS Vendor, nz([InvoiceNumber],\"none\") AS Invoice, Sum"
    ...
    "nvoices ON (vw_SixKeys.InvoiceNumber=DrawnUnitInvoices.Invoice) AND (vw_SixKeys."
    "VendorId=DrawnUnitInvoices.VendorID)\015\012GROUP BY Vendors.VendorSNm, nz([Invo"
