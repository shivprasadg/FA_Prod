...
Begin Report
    ...
    RecSrcDt = Begin
        0x5d0199b58e3be640
    End
    RecordSource ="SELECT * FROM PerDiemSurrender_Batch"
    Caption ="PerDiemBill"
        ...
        Begin FormHeader
            ...
            Begin
                Begin Subform
                    ...
                    Width =14576
                    Height =780
                    Name ="FABankBillBatchHeader"
                    SourceObject ="Report.PerDiemSurrender_Batch_Header"

                    LayoutCachedWidth =14576
        ...
        Begin PageHeader
            ...
            Begin
                Begin TextBox
                    ...
                    ForeColor =16777215
                    Name ="Text336"
                    ControlSource ="=\" ▼BillNo:<b> \" & [BillNo] & \"</b> Schedule:<b> \" & [Schno] & \"</b> - Grou"
                        "p<b>: \" & [SGrpNO] & \"</b> Detail\""
                    TextFormat =1
        ...
        Begin BreakHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    Name ="Text1"
                    ControlSource ="=\"Interim Rent from \" & [billFrom] & \" through \" & [billto]"
                ...
                Begin TextBox
                    ...
                    TabIndex =4
                    Name ="Text252"
                    ControlSource ="=Sum([LineTotal])-Sum(CCur(Nz([Refund],0)))"
                    Format ="$#,##0.00;($#,##0.00)"
                ...
                Begin TextBox
                    ...
                    TabIndex =7
                    Name ="Text256"
                    ControlSource ="=IIf([DueonRec]=-1,\"Payment Due: <strong>On Receipt</strong>\",\"Payment Due: <"
                        "strong>\" & [BillDueDt] & \"</strong>\")"
                    TextFormat =1
        ...
        Begin BreakHeader
            ...
            Begin
                Begin TextBox
                    ...
                    ForeColor =16777215
                    Name ="group"
                    ControlSource ="=\" ▼ Sch: \" & [SchNo] & \"| Group: \" & [SGrpNO]"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =6
                    Name ="taxrate"
                    ControlSource ="=IIf([Taxes]=0,\"--  \",[LTaxRate])"
                    Format ="Percent"
                    GroupTable =1
                ...
                Begin TextBox
                    ...
                    TabIndex =12
                    Name ="IsTaxed"
                    ControlSource ="=IIf([Taxes]=0,\"No\",\"Yes\")"
                    GroupTable =1
        ...
        Begin BreakFooter
            ...
            Begin
                Begin TextBox
                    ...
                    ForeColor =16777215
                    Name ="Text169"
                    ControlSource ="=IIf(Sum([Refund])=0,Null,(Sum([Refund])+Sum([RefundTax]))*-1)"
                    Format ="$#,##0.00;($#,##0.00)"
                ...
                Begin TextBox
                    ...
                    ForeColor =16777215
                    Name ="RefundPreTax"
                    ControlSource ="=IIf(Sum([Refund])=0,Null,Sum([Refund])*-1)"
                    Format ="$#,##0.00;($#,##0.00)"
                ...
                Begin TextBox
                    ...
                    ForeColor =16777215
                    Name ="Text229"
                    ControlSource ="=IIf(Sum([Refund])=0,Null,Sum([LineTotal])-(Sum([Refund])+Sum([RefundTax])))"
                    Format ="$#,##0.00;($#,##0.00)"
                    ControlTipText ="Tot Total"
                ...
                Begin TextBox
                    ...
                    ForeColor =16777215
                    Name ="Text230"
                    ControlSource ="=IIf([Refund]=0,Null,Sum([TotalPerDiem])-Sum([Refund]))"
                    Format ="$#,##0.00;($#,##0.00)"
                ...
                Begin TextBox
                    ...
                    ForeColor =16777215
                    Name ="Text231"
                    ControlSource ="=IIf([Refund]=0,Null,Sum([Taxes])-Sum([RefundTax]))"
                    Format ="$#,##0.00;($#,##0.00)"
                ...
                Begin TextBox
                    ...
                    TabIndex =6
                    Name ="Text232"
                    ControlSource ="=IIf([Refund]=0,Null,Sum([CountMe]) & IIf(Sum([CountMe])>1,\" units\",\" unit\")"
                        " & \" - Group \" & [sgrpno] & \" - Sub Total After Refund ►\")"
                ...
                Begin TextBox
                    ...
                    ForeColor =16777215
                    Name ="Text236"
                    ControlSource ="=IIf(Sum([Refund])=0,Null,Sum([RefundTax])*-1)"
                    Format ="$#,##0.00;($#,##0.00)"
        ...
        Begin BreakFooter
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    FontWeight =700
                    Name ="Text221"
                    ControlSource ="=Sum([LineTotal])-Sum([Refund])"
                    Format ="$#,##0.00;($#,##0.00)"
                    ControlTipText ="LineTot Total"
                ...
                Begin TextBox
                    ...
                    TabIndex =2
                    Name ="instr"
                    ControlSource ="=\"Please reference Invoice number <Strong></i>\" & [BillNo] & \" <i></Strong>wh"
                ...
                Begin TextBox
                    ...
                    ForeColor =255
                    Name ="Text175"
                    ControlSource ="=IIf(IsNull([LTaxRate]) And [unittaxexempt]=No And [sttaxtype]=\"rr\",\"TAX RATE"
                        " MISSING CONTACT OPERATIONS\",Null)"
                ...
                Begin TextBox
                    ...
                    TabIndex =6
                    Name ="Text94"
                    ControlSource ="=IIf(Max([TotalPDNoTax])=0,Null,\"Please Note: Service fees are not taxed. Ancil"
                        "lary fees may be taxable at the units' location local tax rate\")"
        ...
        Begin PageFooter
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =1
                    Name ="Text101"
                    ControlSource ="=\"PDS v1.0 Printed: \" & Now()"
        ...
        Begin FormFooter
            ...
            Begin
                Begin Subform
                    ...
                    Width =14580
                    Height =1439
                    Name ="PerDiemSurrSummary"
                    SourceObject ="Report.PerDiemSurrenderSummary_Batch"
...
End
CodeBehindForm
' See "PerDiemSurrender_Batch.cls"
