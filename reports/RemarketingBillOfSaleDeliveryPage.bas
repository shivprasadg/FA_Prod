...
Begin Report
    ...
    RecordSource ="SELECT vw_BuyersOrder.* FROM vw_BuyersOrder WHERE (((vw_BuyersOrder.InvoiceReque"
        "stNum)=[Forms]![ReMarketInvoiceManager]![InvoiceRequestID]));"
            ...
            Begin
                Begin TextBox
                    ...
                    ControlSource ="=\"The above signed Customer has inspected the vehicle(s) and has detemined the "
                        ...
                        "hicle(s) to the customers satifaction and with respect to the listed vehicle(s),"
                        " the Customer agrees that NO WARRANTY or representations as to the title or mode"
                        "l year have been made or offered by Fleet Advantage LLC, or implied in law, and "
                        "have not formed the basis of the purchase by the Customer\""
                    GroupTable =24
                    LeftPadding =0
                    TopPadding =0
                    RightPadding =0
                ...
                Begin TextBox
                    ...
                    ControlSource ="=\"Equipped to comply with the customers Buyers Order:<b> \" & [InvoiceRequestNu"
                        ...
                        "endments which may have been made from time to time by mutual agreement.\""
                    GroupTable =25
                    LeftPadding =0
                    TopPadding =0
                    RightPadding =0
...
End
CodeBehindForm
' See "RemarketingBillOfSaleDeliveryPage.cls"
