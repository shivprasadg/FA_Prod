        ...
        Begin FormHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =6
                    Name ="Text228"
                    ControlSource ="=UCase([MLNO]) & \" | Schedule \" & [schno] & \" - \" & [GroupNo]"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =3
                    Name ="Text107"
                    ControlSource ="=IIf([UNITSRENT]>0,[UNITSRENT],\"--  \")"
                    Format ="$#,##0.00;($#,##0.00)"
                    GroupTable =1
                ...
                Begin TextBox
                    ...
                    TabIndex =4
                    Name ="Text139"
                    ControlSource ="=IIf([UnitsRent]>0,IIf([UnitTaxExempt]=-1,\"--   \",[TaxAmt]),\"--   \")"
                    Format ="$#,##0.00;($#,##0.00)"
                    GroupTable =1
                ...
                Begin TextBox
                    ...
                    TabIndex =7
                    Name ="taxrate"
                    ControlSource ="=IIf([UNITSRENT]>0,IIf([UnitTaxExempt]=-1,\"--  \",[LTaxRate]),\"--  \")"
                    Format ="Percent"
                    GroupTable =1
                ...
                Begin TextBox
                    ...
                    TabIndex =8
                    Name ="LineTotal"
                    ControlSource ="=[LineTot]+[TaxAmt]+nz([FSLFee],0)"
                    Format ="$#,##0.00;($#,##0.00)"
                    GroupTable =1
                ...
                Begin TextBox
                    ...
                    TabIndex =6
                    Name ="Text236"
                    ControlSource ="=IIf([UnitsRent]>0,IIf([UnitTaxExempt]=-1,\"No\",\"Yes\"),\"--\")"
                    GroupTable =1
                ...
                Begin TextBox
                    ...
                    TabIndex =5
                    Name ="FSLFeeX"
                    ControlSource ="=IIf([FSLFee]=0,\"--   \",[FSLFee])"
                    Format ="$#,##0.00;($#,##0.00)"
                    GroupTable =1
        ...
        Begin BreakFooter
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    ForeColor =-2147483615
                    Name ="Text235"
                    ControlSource ="=Sum([LineTot]+[TaxAmt]+nz([FSLFee],0))"
                    Format ="$#,##0.00;($#,##0.00)"
                    ControlTipText ="LineTot Total"
        ...
        Begin FormFooter
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    FontSize =12
                    Name ="RemitTo"
                    ControlSource ="=[Remitline1] & Chr(13) & Chr(10) & [Remitline2] & Chr(13) & Chr(10) & IIf(IsNul"
                        "l([Remitline3]),Null,[Remitline3] & Chr(13) & Chr(10)) & [Remitline4]"
                    StatusBarText ="default company name"
                ...
                Begin TextBox
                    ...
                    TabIndex =3
                    Name ="Text196"
                    ControlSource ="=IIf(IsNull([sumofbilladj]),Null,[sumofbilladj]+Sum([LineTot]+nz([FSLFee],0)))"
                    Format ="$#,##0.00;($#,##0.00)"
