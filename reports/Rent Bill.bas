        ...
        Begin FormHeader
            ...
            Begin
                Begin TextBox
                    ...
                    FontSize =16
                    Name ="Text1"
                    ControlSource ="=\"Rent Bill from \" & [startdt] & \" through \" & [enddate] & \" for \" & UCase"
                        "([MLNO]) & \" Schedule \" & [schno]"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =5
                    Name ="Text17"
                    ControlSource ="=[pddays]*[unitpdrent]"
                    Format ="$#,##0.00;($#,##0.00)"
                ...
                Begin TextBox
                    ...
                    TabIndex =9
                    Name ="Text23"
                    ControlSource ="=([pddays]*[unitpdrent])+IIf([unittaxexempt]=Yes Or [sttaxtype]<>\"rr\",0,[pdday"
                        "s]*[unitpdrent]*[LTaxRate])"
                    Format ="$#,##0.00;($#,##0.00)"
        ...
        Begin BreakFooter
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =1
                    Name ="Text26"
                    ControlSource ="=Sum(([pddays]*[unitpdrent])+IIf([unittaxexempt]=Yes Or [sttaxtype]<>\"rr\",0,[p"
                        "ddays]*[unitpdrent]*[LTaxRate]))"
                    Format ="$#,##0.00;($#,##0.00)"
                ...
                Begin TextBox
                    ...
                    TabIndex =2
                    Name ="Text27"
                    ControlSource ="=\"Total for \" & [LocationName] & \" (Tax Type \" & [sttaxtype] & \")\""
                ...
                Begin TextBox
                    ...
                    TabIndex =3
                    Name ="Text32"
                    ControlSource ="=Sum([pddays]*[unitpdrent])"
                    Format ="$#,##0.00;($#,##0.00)"
        ...
        Begin FormFooter
            ...
            Begin
                ...
                Begin Label
                    ...
                    FontSize =12
                    Name ="Label49"
                    Caption ="401 East Las Olas Blvd."
                    LayoutCachedLeft =4365
