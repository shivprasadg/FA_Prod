...
Begin Report
    ...
    RecSrcDt = Begin
        0x63cd6541173ce540
    End
    RecordSource ="SELECT vw_PerdiemInvoice.SGrpID, * FROM vw_PerdiemInvoice WHERE (((vw_PerdiemInv"
        "oice.SGrpID)=[Forms]![Billing]![GroupID]) AND ((vw_PerdiemInvoice.BillID)=[Forms"
        "]![Billing]![BillID]));"
    Caption ="Perdiem Bill by Group"
        ...
        Begin BreakFooter
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    ForeColor =16777215
                    Name ="Text229"
                    ControlSource ="=IIf([Refund]=0,Null,Sum([LineTotal])-Sum(CCur(Nz([Refund],0))))"
                    Format ="$#,##0.00;($#,##0.00)"
                    ControlTipText ="Tot Total"
                ...
                Begin TextBox
                    ...
                    ForeColor =16777215
                    Name ="Text231"
                    ControlSource ="=IIf([Refund]=0,Null,Sum([Taxes]))"
                    Format ="$#,##0.00;($#,##0.00)"
                ...
                Begin TextBox
                    ...
                    ForeColor =16777215
                    Name ="Text236"
                    ControlSource ="=IIf([Refund]=0,Null,0)"
                    Format ="$#,##0.00;($#,##0.00)"
        ...
        Begin FormFooter
            ...
            Begin
                ...
                Begin Subform
                    ...
                    TabIndex =3
                    Name ="PerDiem Bill"
                    SourceObject ="Report.PerDiemInvoiceGroupSummary"
