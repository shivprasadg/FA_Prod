...
Begin Report
    ...
    RecSrcDt = Begin
        0x1c48661fb654e540
    End
    RecordSource ="SELECT * FROM vw_PerdiemSurrenderInvoice WHERE (((vw_PerdiemSurrenderInvoice.Bil"
        "lID)=[Forms]![Billing]![BillID]));"
    Caption ="PerDiemBill"
        ...
        Begin FormFooter
            ...
            Begin
                ...
                Begin Subform
                    ...
                    TabIndex =3
                    Name ="PerDiem Bill"
                    SourceObject ="Report.PerDiemSurrenderInvoiceSummary"
...
End
CodeBehindForm
' See "PerDiemSurrenderInvoice.cls"
