...
Begin Report
    ...
    RecSrcDt = Begin
        0xf4926241173ce540
    End
    RecordSource ="SELECT * FROM vw_PerdiemInvoice WHERE (((vw_PerdiemInvoice.[BillID])=[Forms]![Bi"
        "lling]![BillID]));"
    Caption ="PerDiemBill"
        ...
        Begin FormFooter
            ...
            Begin
                ...
                Begin Subform
                    ...
                    TabIndex =3
                    Name ="PerDiem Bill"
                    SourceObject ="Report.PerDiemInvoiceSummary"
