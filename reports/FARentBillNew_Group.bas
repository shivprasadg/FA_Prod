        ...
        Begin FormHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =6
                    Name ="SchBnkClNO"
                    ControlSource ="=IIf(Nz([BankContract],\"\")=\"\",Null,[BankContract])"
                ...
                Begin TextBox
                    ...
                    TabIndex =9
                    Name ="Label218"
                    ControlSource ="=IIf(Nz([BankContract],\"\")=\"\",Null,\"Assignee Contract #:\")"
        ...
        Begin BreakHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =1
                    Name ="Label96"
                    ControlSource ="=IIf(CInt([BillMonths])>1,\"Total \" & [Billmonths] & \" Paymts\",\"Total Paymen"
                        "t\")"
                    GroupTable =1
        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =4
                    Name ="Text139"
                    ControlSource ="=IIf([UnitsbillRent]>0,IIf([UnitTaxExempt]=-1,\"--   \",[taxAmt]),\"--   \")"
                    Format ="$#,##0.00;($#,##0.00)"
                    GroupTable =1
                ...
                Begin TextBox
                    ...
                    TabIndex =7
                    Name ="taxrate"
                    ControlSource ="=IIf([UnitsbillRent]>0,IIf([UnitTaxExempt]=-1,\"--  \",[LTaxRate]),\"--  \")"
                    Format ="Percent"
                    GroupTable =1
                ...
                Begin TextBox
                    ...
                    TabIndex =8
                    Name ="LineTotal"
                    ControlSource ="=[UnitTotalRent]*[BillMonths]"
                    Format ="$#,##0.00;($#,##0.00)"
                    GroupTable =1
                ...
                Begin TextBox
                    ...
                    TabIndex =5
                    Name ="FSLFeeX"
                    ControlSource ="=IIf([FSLFee]=0,\"--   \",CCur([FSLFee]))"
                    Format ="$#,##0.00;($#,##0.00)"
                    GroupTable =1
        ...
        Begin BreakFooter
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    ForeColor =-2147483615
                    Name ="Text235"
                    ControlSource ="=Sum([UnitTotalRent]*[BillMonths])"
                    Format ="$#,##0.00;($#,##0.00)"
                    ControlTipText ="LineTot Total"
                ...
                Begin TextBox
                    ...
                    ForeColor =-2147483615
                    Name ="Text136"
                    ControlSource ="=Count([UnitVin]) & IIf(Count([UnitVin])>1,\" units at \",\" unit at \") & [Loca"
                        "tionName] & \" - Sub Total ►\""
        ...
        Begin BreakFooter
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =4
                    Name ="Text138"
                    ControlSource ="=Count([UnitVin]) & IIf(Count([UnitVin])>1,\" units\",\" unit\") & \" - Group \""
                        " & [sgrpno] & \" - Sub Total ►\""
        ...
        Begin FormFooter
            ...
            Begin
                ...
                Begin Label
                    ...
                    Height =300
                    Name ="Label185"
                    Caption =" Attention: Accounts Receivable"
                ...
                Begin TextBox
                    ...
                    Height =270
                    Name ="Label191"
                    ControlSource ="=\"Please reference Invoice Number: <strong></i>\" & [BillNo] & \"<i></strong> w"
                        "hen remitting payment\""
                    TextFormat =1
                ...
                Begin Subform
                    ...
                    TabIndex =1
                    Name ="BillSummary"
                    SourceObject ="Report.FARentBill_Group_Summary"
                ...
                Begin TextBox
                    ...
                    TabIndex =2
                    Name ="Text279"
                    ControlSource ="=\"Billing Contact Phone Number: <strong>954-615-4400</strong>\""
                    TextFormat =1
                ...
                Begin TextBox
                    ...
                    TabIndex =3
                    Name ="Text284"
                    ControlSource ="=IIf(IsNull([BankContract]),Null,\"Please also reference Contract #  <strong></i"
                        ">\" & [BankContract] & \"<i></strong><br />when remitting payment\")"
                    TextFormat =1
