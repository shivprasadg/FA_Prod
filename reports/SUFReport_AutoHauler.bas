...
Begin Report
    ...
    RecSrcDt = Begin
        0x47504a0db529e540
    End
    RecordSource ="SELECT vw_SUFReportQuery.* FROM vw_SUFReportQuery WHERE LocationID = 28 ORDER BY"
        " UnitVin;"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin Label
                    ...
                    FontWeight =700
                    Name ="Label20"
                    Caption ="If the above address is not correct, please provide the current location address"
                        " below."
                ...
                Begin Label
                    ...
                    Height =345
                    Name ="Label28"
                    Caption ="Date Parked:__________________________                   Odometer Reading:______"
                ...
                Begin TextBox
                    ...
                    TabIndex =4
                    Name ="Label24"
                    ControlSource ="=\"The Unit described above has been parked meeting surrender conditions.\""
                ...
                Begin TextBox
                    ...
                    BackColor =15527148
                    Name ="Text47"
                    ControlSource ="=\"<Strong><u>Note:</u></Strong> Equipment failing to meet the surrender conditi"
                        "on set forth in the lease will continue to be billed<br>              rent until"
                        " the equipment conforms to surrender condition.\""
                    TextFormat =1
                ...
                Begin Label
                    ...
                    Height =420
                    Name ="Label44"
                    Caption ="For refrigerated units, please enter hours on unit when parked:___________"
                    LayoutCachedLeft =570
                ...
                Begin Label
                    ...
                    Height =285
                    Name ="Label83"
                    Caption ="Our remarketing group will contact you to schedule the inspection of the equipme"
                        "nt."
                    LayoutCachedLeft =570
