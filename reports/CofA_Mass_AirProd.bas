            ...
            Begin
                Begin TextBox
                    ...
                    ControlSource ="=IIf([Page]<>\"1\",\"<B>Exhibit A<BR /> to Certificate of Acceptance</B><BR />\""
                        ",\"<B>CERTIFICATE OF ACCEPTANCE</B><Br />\") & \"MASTER EQUIPMENT LEASE AGREEMEN"
                        "T NO:  <Strong>\" & [MLNo] & \"</Strong>  SCHEDULE  NO:  <Strong>\" & [SchNo] & "
                        "\"</Strong>  GROUP:  <Strong>\" & [SGrpNO]"
                    TextFormat =1
