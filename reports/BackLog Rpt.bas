        ...
        Begin FormHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    ForeColor =10040064
                    Name ="Text37"
                    ControlSource ="=\"from \" & [Forms]![WLRpt]![WLRPTstartdt] & \" to \" & [Forms]![WLRpt]![WLRPTe"
                        "nddt]"
            ...
            Begin
                Begin ComboBox
                    ...
                    RowSource ="SELECT lookup_transTypes.TransTypeID, lookup_transTypes.TransType FROM lookup_tr"
                        "ansTypes ORDER BY lookup_transTypes.TransType;"
                    ColumnWidths ="0;2880"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    Format ="$#,##0.00;($#,##0.00)"
                    StatusBarText ="this is a calculated field: unitQty x UnitPrice"
                ...
                Begin TextBox
                    ...
                    TabIndex =3
                    Name ="Text24"
                    ControlSource ="=UCase([groupyear] & \" \" & [groupmake] & \" \" & [groupmodel] & \" \" & [group"
                        "type])"
                ...
                Begin TextBox
                    ...
                    ControlSource ="dealLPAFSent"
                    Format ="mm/dd/yy"
                    StatusBarText ="changed name from dealRFPSent to dealLPAFSent 7-22-10"
                    ShowDatePicker =1
        ...
        Begin BreakFooter
            ...
            Begin
                Begin TextBox
                    ...
                    FontWeight =700
                    Name ="Text41"
                    ControlSource ="=Sum([groupTotal])"
                    Format ="$#,##0.00;($#,##0.00)"
                    ControlTipText ="dealGrandTotal Total"
                ...
                Begin TextBox
                    ...
                    TabIndex =1
                    Name ="Text42"
                    ControlSource ="=Sum([GROUPUNITS])"
                    StatusBarText ="link to lookup_transTypes table"
                    ControlTipText ="transTypeRef Total"
        ...
        Begin BreakFooter
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    Width =2040
                    Height =315
                    Name ="AccessTotalstransTypeRef"
                    ControlSource ="=Count([transTypeRef])"
                    StatusBarText ="link to lookup_transTypes table"
                    ControlTipText ="transTypeRef Total"
                ...
                Begin TextBox
                    ...
                    Height =315
                    TabIndex =1
                    Name ="AccessTotalsdealGrandTotal"
                    ControlSource ="=Sum([groupTotal])"
                    Format ="$#,##0.00;($#,##0.00)"
                    ControlTipText ="dealGrandTotal Total"
