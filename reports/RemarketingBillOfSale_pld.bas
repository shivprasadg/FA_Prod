...
Begin Report
    ...
    RecordSource ="SELECT vw_BuyersOrder.*, * FROM vw_BuyersOrder WHERE (((vw_BuyersOrder.InvoiceRe"
        "questNum)=[Forms]![ReMarketInvoiceManager]![InvoiceRequestID]));"
        ...
        Begin BreakHeader
            ...
            Begin
                ...
                Begin Label
                    ...
                    Height =690
                    Name ="Label105"
                    Caption ="Please be advised that the Buyer noted below, or it's approved representative, w"
                        "ill be picking up the below listed equipment."
                ...
                Begin Label
                    ...
                    FontWeight =700
                    Name ="Label0"
                    Caption ="Unit Pick-Up Authorization"
        ...
        Begin Section
            ...
            Begin
                Begin TextBox
                    ...
                    TabIndex =4
                    Name ="Text101"
                    ControlSource ="=[LCity] & \" \" & UCase([LState]) & \" \" & [LZip]"
                    GroupTable =1
                    LeftPadding =0
                    TopPadding =0
                    RightPadding =0
        ...
        Begin BreakFooter
            ...
            Begin
                ...
                Begin Label
                    ...
                    FontWeight =700
                    Name ="Label62"
                    Caption ="THE   FOREGOING   REPRESENTATIONS   AND   WARRANTIES  ARE   EXPRESSLY   IN   LIE"
                        "U   OF  ANY OTHER  EXPRESSED  OR IMPLIED WARRANTIES,  INCLUDING ANY IMPLIED WARR"
                        "ANTY  OF  MERCHANTABILITY  OR   FITNESS   FOR  A  PARTICULAR  PURPOSE.   THE   A"
                        "BOVE  LISTED   EQUIPMENT   IS  SOLD   \"AS  IS, WHERE IS\"   AND   \"WITH ALL FA"
                        "ULTS\".    THE BUYER ACKNOWLEDGES THAT IT HAS MADE THE SELECTION OF SAID EQUIPME"
                        "NT BASED ON ITS OWN JUDGEMENT AND EXPRESSLY DISCLAIMS ANY RELIANCE UPON STATEMEN"
                        "TS MADE BY SELLER."
        ...
        Begin FormFooter
            ...
            Begin
                Begin Subform
                    ...
                    Width =11520
                    Height =3419
                    Name ="RemarketingBillOfSaleBOSPage"
                    SourceObject ="Report.RemarketingBillOfSaleBOSPage"
                ...
                Begin Subform
                    ...
                    Height =2864
                    TabIndex =1
                    Name ="BuyersDeliveryReceipt"
                    SourceObject ="Report.BuyersDeliveryReceipt"

                    LayoutCachedTop =8220
                    LayoutCachedWidth =11520
                    LayoutCachedHeight =11084
                End
                Begin Subform
                    Locked = NotDefault
                    OldBorderStyle =0
                    ...
                    Height =4559
                    TabIndex =2
                    Name ="RemarketingBillOfSaleCover"
                    SourceObject ="Report.RemarketingBillOfSaleCover"
...
End
CodeBehindForm
' See "RemarketingBillOfSale_pld.cls"
