...
Begin Report
    ...
    RecSrcDt = Begin
        0xb730f8819257e440
    End
    RecordSource ="SELECT Clients.clientCompanyName, Clients.ClientShNm, IIf([clienttype]=\"client\""
        ",1,IIf([clienttype]=\"Guarantor\",2,IIf([clienttype]=\"Target\",3,4))) AS SRT, C"
        "lients.clientDBA, Clients.CLIENTSUB, Clients.[CLIENT GROUP], Clients.CLIENTGRPCN"
        "TRY, Clients.clientType, Clients.creditFYE, Clients.creditFYEreq, Clients.credit"
        "FYERec FROM Clients WHERE (((Clients.[CLIENT GROUP])<>\"maines\" And (Clients.[C"
        "LIENT GROUP])<>\"client demo\") AND ((Clients.clientType)=\"client\" Or (Clients"
        ".clientType)=\"target\" Or (Clients.clientType)=\"2nd target\" Or (Clients.clien"
        "tType)=\"Guarantor\") AND ((Clients.creditFYE) Is Null)) OR (((Clients.[CLIENT G"
        "ROUP])<>\"maines\" And (Clients.[CLIENT GROUP])<>\"client demo\") AND ((Clients."
        "clientType)=\"client\" Or (Clients.clientType)=\"target\" Or (Clients.clientType"
        ")=\"2nd target\" Or (Clients.clientType)=\"Guarantor\") AND ((DateDiff(\"m\",[cr"
        "editfye],Date()))>12)) OR (((Clients.[CLIENT GROUP])<>\"maines\" And (Clients.[C"
        "LIENT GROUP])<>\"client demo\") AND ((Clients.clientType)=\"client\" Or (Clients"
        ".clientType)=\"target\" Or (Clients.clientType)=\"2nd target\" Or (Clients.clien"
        "tType)=\"Guarantor\") AND ((DateDiff(\"d\",[creditfye],Date()))<=75)) OR (((Clie"
        "nts.ClientShNm)=\"maines conklin\") AND ((Clients.clientType)=\"client\") AND (("
        "DateDiff(\"m\",[creditfye],Date()))>12)) OR (((Clients.ClientShNm)=\"maines conk"
        "lin\") AND ((Clients.clientType)=\"client\") AND ((DateDiff(\"d\",[creditfye],Da"
        "te()))<=75)) ORDER BY Clients.clientCompanyName;"
        ...
        Begin FormHeader
            ...
            Begin
                Begin Label
                    ...
                    ForeColor =10040064
                    Name ="Label13"
                    Caption ="Review Financial Receipt"
                ...
                Begin Image
                    ...
                    ImageData = Begin
                        0x474946383961190188007000002c000000001901880087ffffff7bc542008cc5 ,
                        0x6b6b63635a63cecece6b6b73f7efef42a5d6cee6efe6e6ef7b6b739ca5ef9c6b ,
                        0x42736b1073a5106b5a9c42e6529ca51010e65210cee69ca5c5a5d6ef949494a5 ,
                        0x105aa510194210de42109c42cea5219ca519a52919a5087b7b84429ca510735a ,
                        0xbdc5bd0894ce3a739c10315a6ba5c542525a9c63ef3a73de42315a9c31de42ef ,
                        0x194231199c319c9cefa542a5736b63ef6b31de1031196b319c10a5731073196b ,
