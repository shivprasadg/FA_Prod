...
Begin Report
    ...
    RecSrcDt = Begin
        0x6e2b5a6ff600e440
    End
    RecordSource ="LOQvolq"
    DatasheetFontName ="Calibri"
    FilterOnLoad =0
    OnNoDataEmMacro = Begin
        Version =196611
        ColumnsShown =8
        Begin
            Action ="MsgBox"
            Argument ="Nothing meets report paramenters"
            Argument ="-1"
            Argument ="4"
            Argument ="No Data"
        End
        ...
        Begin FormHeader
            ...
            Begin
                Begin TextBox
                    ...
                    ForeColor =10040064
                    Name ="Text14"
                    ControlSource ="=\" Year to Date Awarded vs. Quota\""
                ...
                Begin TextBox
                    ...
                    ForeColor =10040064
                    Name ="Text28"
                    ControlSource ="=\"from \" & [start] & \" to \" & [ed]"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =3
                    Name ="Text37"
                    ControlSource ="=([spcyquota]/12)*(DateDiff(\"m\",[start],[ed])+1)"
                    Format ="$#,##0.00;($#,##0.00)"
                ...
                Begin TextBox
                    ...
                    TabIndex =4
                    Name ="Text50"
                    ControlSource ="=IIf([spcyquota]=0,0,([tot])/(([spcyquota]/12)*(DateDiff(\"m\",[start],[ed])+1))"
                        ")"
                    Format ="Percent"
                ...
                Begin TextBox
                    ...
                    TabIndex =5
                    Name ="Text47"
                    ControlSource ="=IIf([SPCYQuota]=0,0,[tot]/[SPCYQuota])"
                    Format ="Percent"
        ...
        Begin FormFooter
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =1
                    Name ="Text43"
                    ControlSource ="=Sum(([spcyquota]/12)*(DateDiff(\"m\",[start],[ed])+1))"
                    Format ="$#,##0.00;($#,##0.00)"
                ...
                Begin TextBox
                    ...
                    TabIndex =3
                    Name ="Text51"
                    ControlSource ="=Sum([tot])/Sum([SPCYQuota])"
                    Format ="Percent"
                ...
                Begin TextBox
                    ...
                    TabIndex =4
                    Name ="Text53"
                    ControlSource ="=Sum([tot])/Sum(([spcyquota]/12)*(DateDiff(\"m\",[start],[ed])+1))"
                    Format ="Percent"
