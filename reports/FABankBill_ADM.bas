        ...
        Begin FormHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =8
                    Name ="Text276"
                    ControlSource ="=[BillAdj]+Sum([lineTot])"
                    Format ="$#,##0.00;($#,##0.00)"
                    ControlTipText ="TaxAmt Total"
        ...
        Begin BreakHeader
            ...
            Begin
                Begin TextBox
                    ...
                    ForeColor =16777215
                    Name ="Text265"
                    ControlSource ="=\"▼ Group No: \" & [SGrpNO] & \"  - Assignee Lease No: \" & [SgrpBnkNo]"
        ...
        Begin BreakHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    FontWeight =700
                    Name ="LocationName"
                    ControlSource ="=\"Cost Accounting  CD:\" & UCase([UCCC])"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =7
                    Name ="Text304"
                    ControlSource ="=IIf([UnitTaxExempt]=-1,\"--   \",[TaxAmt])"
                    Format ="$#,##0.00;($#,##0.00)"
                    GroupTable =2
        ...
        Begin BreakFooter
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    ForeColor =-2147483615
                    Name ="Text309"
                    ControlSource ="=Count([UnitVIN]) & IIf(Count([UnitVIN])>1,\" units at \",\" unit at \") & [UCCC"
                        "] & \" - Sub Total ►\""
        ...
        Begin FormFooter
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =2
                    Name ="Text197"
                    ControlSource ="=IIf(IsNull([BillAdj]),Null,\"Total Due including Adjustments\")"
                ...
                Begin Label
                    ...
                    Height =285
                    Name ="Label249"
                    Caption ="Bank Account Number:  79056487"
                    LayoutCachedLeft =5580
                    LayoutCachedTop =2520
                    LayoutCachedWidth =9900
                ...
                Begin Label
                    ...
                    Height =285
                    Name ="Label250"
                    Caption ="Account Name: Fifth Third Equipment Finance"
                    LayoutCachedLeft =5580
                ...
                Begin TextBox
                    ...
                    TabIndex =7
                    Name ="Text319"
                    ControlSource ="=Count([UnitVIN]) & IIf(Count([UnitVin])>1,\" units\",\" unit\") & \" - Schedule"
                        " \" & [schno] & \" - Sub Total ►\""
                ...
                Begin TextBox
                    ...
                    ForeColor =-2147483615
                    Name ="Text255"
                    ControlSource ="=\"Invoiced Period <Strong>\" & [BillFrom] & \"</Strong> through <Strong>\" & [B"
                        "illTo]"
                    TextFormat =1
