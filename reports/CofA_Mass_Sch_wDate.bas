...
Begin Report
    ...
    RecSrcDt = Begin
        0x15bdf021968be540
    End
    RecordSource ="CofA_Report_Mass_Sch"
            ...
            Begin
                Begin TextBox
                    ...
                    ControlSource ="=IIf([Page]<>\"1\",\"<B>Exhibit A  </B>\",\"\") & \"<B>Certificate Of Acceptance"
                        ...
                        "EDULE  NO:  <B>\" & [SchNo] & \" </B>\" & GroupsNoinSchedule([Schid],0,True) & \""
                        "\""
                    TextFormat =1
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    ControlSource ="=\"4. Lessee acknowledges that signature of this document (a) constitutes uncond"
                        ...
                        "the Master Equipment Lease Agreement No. \" & [MLNo] & \" dated as of  \" & Form"
                        "at([mlMO],\"mmmm\") & \" \" & [MLDAY] & \", \" & [MLYR] & \" by and between Less"
                        "or and Lessee (as may be amended from time to time) and the Schedule thereunder "
                        "relating to the Exhibit A Equipment, (b) that such acceptance is not on a trial "
                        "basis, and (c) authorizes commencement of the Lease Term under the Master Equipm"
                        "ent Lease Agreement and Schedule.\""
                    GroupTable =41
