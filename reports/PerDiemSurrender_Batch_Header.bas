...
Begin Report
    ...
    RecSrcDt = Begin
        0xa1e2d690b33be640
    End
    RecordSource ="SELECT PerDiemSurrender_Batch.BillID, PerDiemSurrender_Batch.BillNo, PerDiemSurr"
        "ender_Batch.Billdt, PerDiemSurrender_Batch.aSort, PerDiemSurrender_Batch.SchNo, "
        "PerDiemSurrender_Batch.SGrpNO AS GroupNo, PerDiemSurrender_Batch.Billfrom, PerDi"
        "emSurrender_Batch.Billto, Avg(PerDiemSurrender_Batch.PDDays) AS PDDays, Sum(PerD"
        "iemSurrender_Batch.BasePerDiem) AS BasePerDiem, Avg(PerDiemSurrender_Batch.PDRen"
        "t) AS PDRent, Sum(PerDiemSurrender_Batch.PDTax) AS PDTax, Sum(PerDiemSurrender_B"
        "atch.LineTotal) AS LineTotal, Count(PerDiemSurrender_Batch.UnitID) AS UnitCount,"
        " PerDiemSurrender_Batch.BillingAddress, Min(\"\") AS BankName FROM PerDiemSurren"
        "der_Batch GROUP BY PerDiemSurrender_Batch.BillID, PerDiemSurrender_Batch.BillNo,"
        " PerDiemSurrender_Batch.Billdt, PerDiemSurrender_Batch.aSort, PerDiemSurrender_B"
        "atch.SchNo, PerDiemSurrender_Batch.SGrpNO, PerDiemSurrender_Batch.Billfrom, PerD"
        "iemSurrender_Batch.Billto, PerDiemSurrender_Batch.BillingAddress ORDER BY PerDie"
        "mSurrender_Batch.Billdt, PerDiemSurrender_Batch.aSort, PerDiemSurrender_Batch.SG"
        "rpNO;"
    Caption ="PDSurrenderBatchHeader"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    Name ="Text286"
                    ControlSource ="=\"For:<Strong> \" & [BillFrom] & \"</Strong> ~ <Strong>\" & [BillTo]"
                    TextFormat =1
