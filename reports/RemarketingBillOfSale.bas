        ...
        Begin FormHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    FontSize =12
                    Name ="Text96"
                    ControlSource ="=\"Today, we have confirmed receipt of funds wired  completeing the purchase of:"
                        "<ul><ul><li><b> \" & Count([vin]) & \" </b>\" & IIf(Count([vin])<2,\"vehicle\",\""
                        "vehicles\") & \" as listed on Buyer's Order:<b> \" & [InvoiceRequestNum] & \"</b"
                        ">.</li>\015\012<li> For the total amount of:<b> \" & Format((Sum([SalePrice])+Su"
                        "m([Taxes])+Sum([DocFee])),\"Currency\") & \"</b><i> (may include taxes and fees)"
                        "</i></li></ul></ul><br>Enclosed you will find the:<ul><ul><li><b> Bill of Sale</"
                        "li><li> Unit Release Authorization Form</li><li> Buyer's Delivery Receipt</b></l"
                        "i></ul></ul><Br>Please fill out and sign all the required fields on the<b> Bill "
                        "of Sale</b> and send it back to your salesperson.<br>After receiving the<b><i> s"
                        "igned</i> Bill of Sale</b> from the buyer, Fleet Advantage will notify the stora"
                        "ge yard, authorizing the release of \" & IIf(Count([vin])<2,\"this unit\",\"thes"
                        "e units\") & \". All vehicles listed,<b> must be picked-up within (7) days</b> a"
                        "fter the payment is made in full. After this period, any incurred additional sto"
                        "rage charges may be the buyers responsibility.<br><br><b>Please Note: </b>You or"
                        " your agent will be required to sign the<b> Buyer's Delivery Receipt</b> upon pi"
                        "ckup.<br>\015\012<br>Feel free to contact our office should you have any questio"
                        "ns.<br>\015\012<br> Thank you for your business.\015\012<br>\015\012<br>    Rema"
                        "rketing Department \015\012<br>    FLEET ADVANTAGE, LLC  \015\012<br>    Tel: 95"
                        "4-615-4400\""
                    TextFormat =1
        ...
        Begin FormFooter
            ...
            Begin
                Begin Subform
                    ...
                    Width =11640
                    Height =2100
                    Name ="RemarketingBillOfSalePickUpPage"
                    SourceObject ="Report.RemarketingBillOfSalePickUpPage"
                ...
                Begin Subform
                    ...
                    Width =11640
                    TabIndex =1
                    Name ="RemarketingBillOfSaleDeliveryPage"
                    SourceObject ="Report.RemarketingBillOfSaleDeliveryPage"
