        ...
        Begin FormHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    Name ="Text1"
                    ControlSource ="=\"Notice and Acknowledgement of Assignment\""
                ...
                Begin TextBox
                    ...
                    ForeColor =-2147483615
                    Name ="Text1185"
                    ControlSource ="=\"Dated: \" & Format(Date(),\"mmmm dd\"\", \"\"yyyy\")"
                    FontName ="Times New Roman"
        ...
        Begin BreakHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =4
                    Name ="Text982"
                    ControlSource ="=[BankRemitAddress]"
                    FontName ="Times New Roman"
                ...
                Begin TextBox
                    ...
                    Height =720
                    TabIndex =1
                    Name ="LesseeAddressLine"
                    ControlSource ="=[LesseeAddress]"
                    FontName ="Times New Roman"
                    LeftPadding =0
                ...
                Begin TextBox
                    ...
                    RightMargin =144
                    Name ="FABox1"
                    ControlSource ="=\"Very truly yours,<br /><br />FLEET ADVANTAGE, LLC<br /> (Lessor)<br /><br /><"
                        "br /><br />\015\012By: ___________________________________<br /><br />Name: Bria"
                        "n K. Holland<br />\012Title: President and CEO<br /><br />Date: ________________"
                        "_________________\""
                    FontName ="Times New Roman"
                    GroupTable =1
                    LeftPadding =0
                ...
                Begin TextBox
                    ...
                    RightMargin =144
                    Name ="LesseBox1"
                    ControlSource ="=\"ACCEPTED AND CONFIRMED:<br /><br />\" & [Lessee] & \"<br /> (Lessee) <br /><b"
                        "r /><br /><br />\015\012By: ___________________________________<br /><br />Name:"
                        " ________________________________<br /><br />Title: ____________________________"
                        "_____<br /><br />Date: _________________________________\""
                    FontName ="Times New Roman"
                    GroupTable =1
                    LeftPadding =0
                    TopPadding =0
