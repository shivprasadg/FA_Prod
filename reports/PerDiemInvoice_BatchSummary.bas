...
Begin Report
    ...
    RecSrcDt = Begin
        0xb84a3b7eb139e640
    End
    RecordSource ="SELECT FAPerDiemBatch.LocationName, FAPerDiemBatch.LState, FAPerDiemBatch.SchNo,"
        " FAPerDiemBatch.sttaxtype, FAPerDiemBatch.UnitTaxExempt, Sum(FAPerDiemBatch.Coun"
        "tme) AS UnitCount, Sum(FAPerDiemBatch.TotalPerDiem) AS TotalPerDiem, Sum(FAPerDi"
        "emBatch.Taxes) AS TotalTaxes, Sum(FAPerDiemBatch.Refund) AS Refund, Sum(FAPerDie"
        "mBatch.RefundTax) AS RefundTax, Sum(FAPerDiemBatch.LineTotal) AS LineTotal, Sum("
        "FAPerDiemBatch.PDDAYS) AS TotPDDAYS FROM FAPerDiemBatch GROUP BY FAPerDiemBatch."
        "LocationName, FAPerDiemBatch.LState, FAPerDiemBatch.SchNo, FAPerDiemBatch.sttaxt"
        "ype, FAPerDiemBatch.UnitTaxExempt;"
