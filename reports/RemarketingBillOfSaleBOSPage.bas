...
Begin Report
    ...
    RecSrcDt = Begin
        0xb82a009756b1e540
    End
    RecordSource ="SELECT vw_BuyersOrder.*\015\012FROM vw_BuyersOrder\015\012WHERE (((vw_BuyersOrde"
        "r.InvoiceRequestNum)=[Forms]![ReMarketInvoiceManager]![InvoiceRequestID]));\015\012"
        ...
        Begin FormHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    FontSize =12
                    Name ="Text96"
                    ControlSource ="=\"In consideration of <u>\" & Format(Sum([SoldPrice]+[WarrantyPrice]),\"Currenc"
                        "y\") & \"</u> Fleet Advantage, LLC (\"\"Seller\"\") hereby sells and transfers a"
                        "ll its rights,<br>title and interest in the Equipment described below to:\""
                    TextFormat =1
        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =3
                    Name ="Text101"
                    ControlSource ="=[LCity] & \" \" & UCase([LState]) & \" \" & Left([LZip],5)"
                    GroupTable =3
                    LeftPadding =0
                    TopPadding =0
                    RightPadding =0
        ...
        Begin BreakFooter
            ...
            Begin
                Begin Label
                    ...
                    Height =1095
                    Name ="Label61"
                    Caption ="Seller  hereby  represents   and  warrants   to  Buyer   that  Seller   has  ful"
                        "l  right,   power,   and  authority  to  sell   said Equipment,   and  to execut"
                        "e this  Bill of Sale  and that the  Equipment is  free  and  clear  of  all  lie"
                        "ns and  encumbrances arising  through  or created by Seller.  Odometer  certific"
                        "ations,  if required,  will be furnished on an individual  VIN  basis.  Seller a"
                        "grees to provide appropriate Certificates of Title for the above listed Equipmen"
                        "t."
                    LayoutCachedTop =840
                ...
                Begin Label
                    ...
                    FontWeight =700
                    Name ="Label62"
                    Caption ="THE   FOREGOING   REPRESENTATIONS   AND   WARRANTIES  ARE EXPRESSLY IN LIEU OF A"
                        "NY OTHER  EXPRESSED  OR IMPLIED WARRANTIES,  INCLUDING ANY IMPLIED WARRANTY OF M"
                        "ERCHANTABILITY OR  FITNESS FOR  A  PARTICULAR  PURPOSE.  THE  ABOVE LISTED  EQUI"
                        "PMENT IS  SOLD  \"AS IS, WHERE IS\"   AND  \"WITH ALL FAULTS\".   THE BUYER ACKN"
                        "OWLEDGES THAT IT HAS MADE THE SELECTION OF SAID EQUIPMENT BASED ON ITS OWN JUDGE"
                        "MENT AND EXPRESSLY DISCLAIMS ANY RELIANCE UPON STATEMENTS MADE BY SELLER."
                ...
                Begin Label
                    ...
                    Height =1635
                    Name ="Label63"
                    Caption ="IN WITNESS WHEREOF, Seller has caused this Bill of Sale to be executed and deliv"
                        "ered, and Buyer has executed this Bill of Sale accepting the equipment and deliv"
                        "ered same to Seller.  This Bill of Sale may be executed in counterparts which to"
                        "gether form one and the same agreement, and copies transmitted by image or facsi"
                        "mile shall have the same force as manually signed originals delivered in hand. I"
                        "n the event the consideration provided is not paid in immediately available fede"
                        "ral funds and is dishonored, delayed or invalidated for any reason, this Bill of"
                        " Sale is null and void without notice and Buyer shall pay Seller's damages and a"
                        "ll costs of collection and enforcement, including attorney's fees and expenses."
                ...
                Begin TextBox
                    ...
                    FontSize =12
                    Name ="Text98"
                    ControlSource ="=Sum([SoldPrice])+Sum([Taxes])+Sum([DocFee])+Nz(Sum([WarrantyPrice]),0)"
                    Format ="$#,##0.00;($#,##0.00)"
                ...
                Begin TextBox
                    ...
                    TabIndex =1
                    Name ="Text146"
                    ControlSource ="=Sum([Taxes])+Sum([DocFee])"
                    Format ="$#,##0.00;($#,##0.00)"
                    GroupTable =4
                    LeftPadding =0
                    TopPadding =0
...
End
CodeBehindForm
' See "RemarketingBillOfSaleBOSPage.cls"
