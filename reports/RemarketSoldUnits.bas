...
Begin Report
    ...
    RecSrcDt = Begin
        0x7139d453b779e440
    End
    RecordSource ="RemarketingSalesReport"
    ...
    Begin
        ...
        Begin BreakLevel
            SortOrder = NotDefault
            GroupHeader = NotDefault
            ControlSource ="SoldYear"
        End
        Begin BreakLevel
            SortOrder = NotDefault
            GroupHeader = NotDefault
            GroupFooter = NotDefault
            ControlSource ="SoldMonth"
        End
        Begin BreakLevel
            GroupHeader = NotDefault
            GroupFooter = NotDefault
        ...
        Begin FormHeader
            ...
            Begin
                ...
                Begin Label
                    ...
                    ForeColor =16777215
                    Name ="Label31"
                    Caption ="Remarketing SOLD Units Report"
                    LayoutCachedLeft =15
                    LayoutCachedTop =60
        ...
        Begin BreakHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    ForeColor =16777215
                    Name ="SaleType"
                    ControlSource ="=IIf([UnitStatus]=\"S\",\"Sold Units\",\"Brokered Units\")"
                ...
                Begin TextBox
                    ...
                    ForeColor =16777215
                    Name ="YearProfit"
                    ControlSource ="=Sum(([UnitSalePrice]+[WarrantyPrice])-([BuyOut]+[TotalExpense]+[WarrantyCost]))"
                    Format ="$#,##0.00;($#,##0.00)"
                ...
                Begin TextBox
                    ...
                    ForeColor =16777215
                    Name ="YearMargin"
                    ControlSource ="=IIf([BuyOut]<1,0,([TotalSold]-[Totalcost])/[TotalCost])"
                    Format ="Percent"
                ...
                Begin TextBox
                    ...
                    ForeColor =6108695
                    Name ="Text58"
                    ControlSource ="=Count([UnitId]) & IIf(Count([UnitId])<2,\"Unit Sold \",\" Units Sold \") & \"-\""
                        " & [soldyear] & \" Totals ►\""
        ...
        Begin BreakHeader
            ...
            Begin
                Begin TextBox
                    ...
                    FontWeight =700
                    Name ="MonthSold"
                    ControlSource ="=\"▼ \" & Format([SoldMonth] & \"/1/2000\",\"mmmm\") & \" Sales\""
        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    BackColor =15858167
                    Name ="Text24"
                    ControlSource ="=([UnitSalePrice]+[WarrantyPrice])-([BuyOut]+[TotalExpense]+[WarrantyCost])"
                    Format ="$#,##0.00;($#,##0.00)"
        ...
        Begin BreakFooter
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    ForeColor =6108695
                    Name ="Text51"
                    ControlSource ="=Count([UnitId]) & IIf(Count([UnitId])<2,\"Unit Sold \",\" Units Sold \") & Form"
                        "at([SoldMonth] & \"/1/2000\",\"mmm\") & \"-\" & [soldyear] & \" Totals ►\""
                ...
                Begin TextBox
                    ...
                    ForeColor =6108695
                    Name ="Text75"
                    ControlSource ="=Format(Round([TMonthSold]/[YearSoldPrice],4),\"Percent\") & \" of \" & [soldyea"
                        "r] & \" sales ►\""
                    Format ="Percent"
