        ...
        Begin FormHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    RightMargin =144
                    Name ="Text1189"
                    ControlSource ="=\"Lessee:\" & [clientCompanyName]"
                    FontName ="Times New Roman"
                ...
                Begin Subform
                    ...
                    Height =720
                    TabIndex =4
                    Name ="PayProceeds_Sch"
                    SourceObject ="Report.PayProceeds_Sch"

                    LayoutCachedTop =2760
                    LayoutCachedWidth =10567
        ...
        Begin BreakFooter
            ...
            Begin
                Begin TextBox
                    ...
                    RightMargin =29
                    Name ="Text1225"
                    ControlSource ="=IIf(Sum([PayInterim])>0,Sum([PayInterim]),Null)"
                    Format ="$#,##0.00;($#,##0.00)"
                    FontName ="Times New Roman"
                    GroupTable =7
                ...
                Begin TextBox
                    ...
                    RightMargin =29
                    Name ="Text1226"
                    ControlSource ="=IIf(Sum([PayInterim])>0,[InterimPayInst],Null)"
                    FontName ="Times New Roman"
                    GroupTable =7
                ...
                Begin TextBox
                    ...
                    RightMargin =29
                    Name ="Label1227"
                    ControlSource ="=IIf(Sum([PayInterim])>0,\"Pay Interim\",Null)"
                    FontName ="Times New Roman"
                    GroupTable =7
