...
Begin Report
    ...
    RecSrcDt = Begin
        0x0572ec4a4dc5e440
    End
    RecordSource ="SELECT * FROM RMKTInventoryFinal WHERE (((RMKTInventoryFinal.ClientId)=[Forms]!["
        "Rmkt Menu]![ClientId]));"
        ...
        Begin FormHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    ForeColor =16777215
                    Name ="Label31"
                    ControlSource ="=[ClientShNm] & \" | RMKT Inventory \""
        ...
        Begin BreakHeader
            ...
            Begin
                Begin TextBox
                    ...
                    ForeColor =8210719
                    Name ="Text43"
                    ControlSource ="=\"| Schdule: \" & ([SCHNO]) & \" | Group: \" & [SGRPNO] & \" |  Units: \" & Cou"
                        "nt([unitvin]) & \" |\""
                    Format =">"
                ...
                Begin Label
                    ...
                    GroupTable =1
                    BottomPadding =38
                    LayoutCachedLeft =14316
                    LayoutCachedTop =276
                    LayoutCachedWidth =15276
                    LayoutCachedHeight =504
                    ColumnStart =15
                    ColumnEnd =15
                    LayoutGroup =1
        ...
        Begin Section
            ...
            Begin
                Begin TextBox
                    ...
                    BorderColor =-2147483615
                    Name ="Text23"
                    ControlSource ="=IIf([unitstatus]<>\"TR\",DateDiff(\"d\",[BuyOutDate],Date())+1,Null)"
                    GroupTable =1
                    RightPadding =38
                    BottomPadding =38
                ...
                Begin TextBox
                    ...
                    TabIndex =5
                    Name ="Text62"
                    ControlSource ="=IIf(IsNull([parkdt]),IIf(IsNull([BuyOutDate]),[unitoffleasedt],[BuyOutDate]) & "
                        "\"*\",[parkdt])"
                    GroupTable =1
                    BottomPadding =38
                ...
                Begin TextBox
                    ...
                    Begin
                        Begin Label
                            ...
                            Height =285
                            Name ="Label63"
                            Caption ="*If Park date is not known, buyout date is used. If Park date and, buyout are un"
                                "known, off lease date is used."
