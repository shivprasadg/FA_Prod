...
Begin Report
    ...
    Left =7035
    Top =2175
    Filter ="([PDq2].[UnitUnitNum]=\"272902\")"
        ...
        Begin FormHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =6
                    Name ="Text188"
                    ControlSource ="=IIf(IsNull([BillDueDt]),[billStDt],[BillDueDt])"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =10
                    Name ="Tax"
                    ControlSource ="=IIf([UnitTaxExempt]=-1,\"--   \",IIf([unittaxexempt]=Yes Or [sttaxtype]<>\"rr\""
                        ",0,([pddays]*[unitpdrent]+IIf([sgrpnoslv]=0,0,[slvdays]*[slvrent]))*[LTaxRate]))"
                    Format ="$#,##0.00;($#,##0.00)"
                    GroupTable =1
        ...
        Begin BreakFooter
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    ForeColor =-2147483615
                    Name ="Text247"
                    ControlSource ="=Sum(IIf([sgrpnopd]=Yes Or [pddays]=0,0,[pddays]*[unitpdrent]))"
                    Format ="$#,##0.00;($#,##0.00)"
                ...
                Begin TextBox
                    ...
                    ForeColor =-2147483615
                    Name ="Text248"
                    ControlSource ="=Sum(IIf([unittaxexempt]=Yes Or [sttaxtype]<>\"rr\",0,([pddays]*[unitpdrent]+IIf"
                        "([sgrpnoslv]=0,0,[slvdays]*[slvrent]))*[LTaxRate]))"
                    Format ="$#,##0.00;($#,##0.00)"
