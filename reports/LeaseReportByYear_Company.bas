...
Begin Report
    ...
    RecSrcDt = Begin
        0x8b21b0eb9f8fe440
    End
    RecordSource ="LeaseReportByYear"
        ...
        Begin FormHeader
            ...
            Begin
                ...
                Begin Label
                    ...
                    ForeColor =16777215
                    Name ="Label31"
                    Caption ="Lease Cost By Year Report by Company"
                    LayoutCachedLeft =15
                    LayoutCachedTop =60
        ...
        Begin BreakHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    ForeColor =16777215
                    Name ="YearChildCost"
                    ControlSource ="=Sum([TotalChildCost])"
                    Format ="$#,##0.00;($#,##0.00)"
        ...
        Begin BreakHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    BorderColor =-2147483617
                    ForeColor =-2147483615
                    Name ="UnitCostPctofYear"
                    ControlSource ="=Round([UnitCost]/[YearUnitCost],3)"
                    Format ="Percent"
                    GroupTable =1
                    RightPadding =38
                ...
                Begin TextBox
                    ...
                    ForeColor =-2147483615
                    Name ="PctChild"
                    ControlSource ="=IIf([TotalChildCost]>0,Round([TotalChildCost]/[YearChildCost],3),0)"
                    Format ="Percent"
                    GroupTable =3
                    RightPadding =38
                ...
                Begin TextBox
                    ...
                    ForeColor =-2147483615
                    Name ="Text85"
                    ControlSource ="=Round([totalCost]/[YearTotalUnitCost],3)"
                    Format ="Percent"
                    GroupTable =6
                    RightPadding =38
                ...
                Begin TextBox
                    ...
                    ForeColor =-2147483615
                    Name ="UnitPercent"
                    ControlSource ="=Round([UnitCount]/[YearUnitCount],3)"
                    Format ="Percent"
                    GroupTable =7
                    RightPadding =38
        ...
        Begin BreakFooter
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    ForeColor =-2147483617
                    Name ="TMonthSold"
                    ControlSource ="=Sum([Refrig]+[OBC]+[OBCInstall]+[Decals]+[FeesTax]+[Freight]+[Inspection]+[OilR"
                        "ig]+[OtherCost]+[TankBodies]+[Warranty])"
                    Format ="$#,##0.00;($#,##0.00)"
                ...
                Begin TextBox
                    ...
                    BorderColor =-2147483615
                    ForeColor =-2147483617
                    Name ="stUnitCostPctofYear"
                    ControlSource ="=Round(Sum([UnitCost])/[YearUnitCost],3)"
                    Format ="Percent"
                ...
                Begin TextBox
                    ...
                    ForeColor =6108695
                    Name ="Text75"
                    ControlSource ="=[Make] & \" - \" & [LeaseYear] & \"  Totals ►\""
                    Format ="Percent"
                ...
                Begin TextBox
                    ...
                    ForeColor =-2147483617
                    Name ="Text86"
                    ControlSource ="=Round(Sum([totalCost])/[YearTotalUnitCost],3)"
                    Format ="Percent"
                ...
                Begin TextBox
                    ...
                    ForeColor =-2147483617
                    Name ="Text97"
                    ControlSource ="=Round(Sum([UnitCount])/[YearUnitCount],3)"
                    Format ="Percent"
                ...
                Begin TextBox
                    ...
                    ForeColor =-2147483617
                    Name ="Text98"
                    ControlSource ="=IIf(Sum([TotalChildCost])>0,Round(Sum([TotalChildCost])/[YearChildCost],3),0)"
                    Format ="Percent"
