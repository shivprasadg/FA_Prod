...
Begin Report
    ...
    RecSrcDt = Begin
        0x5e89a36c8cafe540
    End
    RecordSource ="SELECT * FROM vw_PerDiemSurrenderByLocation WHERE (((vw_PerDiemSurrenderByLocati"
        "on.BillID)=[Forms]![Billing]![BillID]));"
    Caption ="PerDiemBill"
        ...
        Begin BreakHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =4
                    Name ="Text253"
                    ControlSource ="=[BillNo] & \"-\" & [LocationID]"
...
End
CodeBehindForm
' See "PerDiemSurrenderInvoiceLocation.cls"
