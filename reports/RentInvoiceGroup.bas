...
Begin Report
    ...
    RecordSource ="SELECT vw_RentInvoice.* FROM vw_RentInvoice WHERE (((vw_RentInvoice.BillID)=[For"
        "ms]![Billing]![BillID]) AND ((vw_RentInvoice.GroupID)=[Forms]![Billing]![GroupID"
        "]));"
        ...
        Begin FormHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =4
                    Name ="Text228"
                    ControlSource ="=UCase([MLNO]) & \" | Schedule \" & [schedule] & \" | Group \" & [UnitGroup]"
        ...
        Begin FormFooter
            ...
            Begin
                ...
                Begin Subform
                    ...
                    Height =1232
                    Name ="InvoiceSummary"
                    SourceObject ="Report.RentInvoiceSummaryGroup"
                    LinkChildFields ="BillID;GroupID"
                    LinkMasterFields ="BillID;GroupID"
                ...
                Begin TextBox
                    ...
                    LayoutCachedLeft =11616
                    LayoutCachedTop =2028
                    LayoutCachedWidth =14148
