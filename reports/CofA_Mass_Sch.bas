            ...
            Begin
                ...
                Begin TextBox
                    ...
                    ControlSource ="=\"4. Lessee acknowledges that signature of this document (a) constitutes uncond"
                        ...
                        "at(CDate([MLDt]),\"mmmm d\"\", \"\"yyyy\") & \" by and between Lessor and Lessee"
                        " (as may be amended from time to time) and the Schedule thereunder relating to t"
                        "he Exhibit A Equipment, (b) that such acceptance is not on a trial basis, and (c"
                        ") authorizes commencement of the Lease Term under the Master Equipment Lease Agr"
                        "eement and Schedule.\""
                    GroupTable =41
