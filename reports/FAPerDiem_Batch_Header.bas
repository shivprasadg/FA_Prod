...
Begin Report
    ...
    RecSrcDt = Begin
        0x95495c09b339e640
    End
    RecordSource ="SELECT FAPerDiemBatch.BillID, FAPerDiemBatch.BillNo, FAPerDiemBatch.SchNo, FAPer"
        "DiemBatch.Billdt, FAPerDiemBatch.Billfrom, FAPerDiemBatch.Billto, Avg(FAPerDiemB"
        "atch.PDDays) AS PDDays, Avg(FAPerDiemBatch.PDRent) AS PDRent, Sum(FAPerDiemBatch"
        ".PDTax) AS PDTax, Sum(FAPerDiemBatch.LineTotal) AS LineTotal, Count(FAPerDiemBat"
        "ch.UnitID) AS UnitCount, FAPerDiemBatch.CompanyName FROM FAPerDiemBatch GROUP BY"
        " FAPerDiemBatch.BillID, FAPerDiemBatch.BillNo, FAPerDiemBatch.SchNo, FAPerDiemBa"
        "tch.Billdt, FAPerDiemBatch.Billfrom, FAPerDiemBatch.Billto, FAPerDiemBatch.Compa"
        "nyName ORDER BY FAPerDiemBatch.BillNo;"
    Caption ="FABankBillBatchHeader"
        ...
        Begin FormFooter
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    ForeColor =16777215
                    Name ="SubtotalUnits"
                    ControlSource ="=Sum([PDDays])"
                    Format ="$#,##0.00;($#,##0.00)"
                    ControlTipText ="LineTot Total"

                    LayoutCachedLeft =9415
                    LayoutCachedTop =30
                    LayoutCachedWidth =10570
