...
Begin Report
    ...
    RecordSource ="SELECT Clients.clientCompanyName, ScheduleCoLessee.ScheduleID, ScheduleCoLessee."
        "CoLesseeID, ScheduleCoLessee.CoLesseeLabel, ScheduleCoLessee.CoLesseeTaxID FROM "
        "ScheduleCoLessee INNER JOIN Clients ON ScheduleCoLessee.CoLesseeID = Clients.cli"
        "entID;"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    BorderColor =14277081
                    Name ="Label11"
                    ControlSource ="=IIf(Nz([CoLesseeID],0)=0,Null,\"Tax ID\")"
                    LeftPadding =0
                    TopPadding =0
                    RightPadding =0
                    BottomPadding =0
