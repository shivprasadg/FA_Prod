...
Begin Report
    ...
    RecSrcDt = Begin
        0x7923f320b43be640
    End
    RecordSource ="SELECT PerDiemSurrender_Batch.BillNo, PerDiemSurrender_Batch.LocationID, PerDiem"
        "Surrender_Batch.LocationName, PerDiemSurrender_Batch.LState, PerDiemSurrender_Ba"
        "tch.SchNo, Sum(PerDiemSurrender_Batch.CountMe) AS UnitCount, Sum(PerDiemSurrende"
        "r_Batch.PDDays) AS TotPDDays, Sum(PerDiemSurrender_Batch.TotalPerDiem) AS TotalP"
        "erDiem, Sum(PerDiemSurrender_Batch.TotalPDNoTax) AS TotalPDNoTax, Sum(PerDiemSur"
        "render_Batch.PDTax) AS TotalTaxes, Sum(PerDiemSurrender_Batch.LineTotal) AS Line"
        "Total, Sum(PerDiemSurrender_Batch.Refund) AS Refund, Sum(PerDiemSurrender_Batch."
        "RefundTax) AS RefundTax FROM PerDiemSurrender_Batch GROUP BY PerDiemSurrender_Ba"
        "tch.BillNo, PerDiemSurrender_Batch.LocationID, PerDiemSurrender_Batch.LocationNa"
        "me, PerDiemSurrender_Batch.LState, PerDiemSurrender_Batch.SchNo ORDER BY PerDiem"
        "Surrender_Batch.BillNo;"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    BorderColor =-2147483615
                    Name ="Text260"
                    ControlSource ="=\"Invoice No: \" & [BillNo] & \" ►\""
