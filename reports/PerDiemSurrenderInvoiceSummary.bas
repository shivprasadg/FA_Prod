...
Begin Report
    ...
    RecordSource ="SELECT PD.LocationName, PD.LState, PD.SchNo, PD.sttaxtype, PD.UnitTaxExempt, Sum"
        ...
        "ineTotal) AS LineTotal, Sum(PD.PDDAYS) AS TotPDDAYS, PD.BillID FROM vw_PerdiemSu"
        "rrenderInvoice AS PD GROUP BY PD.LocationName, PD.LState, PD.SchNo, PD.sttaxtype"
        ", PD.UnitTaxExempt, PD.BillID HAVING (((PD.BillID)=[Forms]![Billing]![BillID]));"
