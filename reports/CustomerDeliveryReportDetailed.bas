...
Begin Report
    ...
    RecSrcDt = Begin
        0x2515519cafd5e440
    End
    RecordSource ="SELECT vw_CustomerDeliveryReport.*, IIf(IsNull([UnitMSOCopy]) And IsNull([MSORec"
        "d]),Null,Format(Nz([MSORecd],[UnitMSOCopy]),\"mm/dd/yy\")) AS MSO, IIf(IsNull([U"
        "nitMSOCopy]) And IsNull([MSORecd]),Null,IIf(IsNull([MSORecd]),\"C\",\"O\")) AS M"
        "SOInd FROM vw_CustomerDeliveryReport;"
        ...
        Begin FormHeader
            ...
            Begin
                Begin Label
                    ...
                    FontWeight =700
                    Name ="Label17"
                    Caption ="Customer Delivery Report - Detailed"
        ...
        Begin BreakHeader
            ...
            Begin
                Begin TextBox
                    ...
                    FontWeight =700
                    Name ="Text216"
                    ControlSource ="=\"Schedule \" & [SchNo] & \" - \" & [schshortDesc]"
                    TextFormat =1
        ...
        Begin BreakHeader
            ...
            Begin
                Begin TextBox
                    ...
                    ForeColor =255
                    Name ="Text87"
                    ControlSource ="=IIf([sgrpplb]=True,\"PLB\",Null)"
                ...
                Begin TextBox
                    ...
                    TabIndex =1
                    Name ="Text218"
                    ControlSource ="=\"Unit Group \" & [SGrpNO] & \"  - \" & [GroupCount] & IIf([GroupCount]=1,\" Un"
                        "it\",\" Units\")"
                    TextFormat =1
                ...
                Begin TextBox
                    ...
                    TabIndex =2
                    Name ="GroupCount"
                    ControlSource ="=DCount(\"AssetId\",\"vw_sixkeys\",\"sgrpid=\" & [sgrpid])"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    ControlSource ="ChildVendorPaidDate"
                    Format ="mm/dd/yy"
                    ShowDatePicker =1
                ...
                Begin TextBox
                    ...
                    TabIndex =3
                    Name ="Text103"
                    ControlSource ="=IIf(IsNull([childyear]),Null,[childyear] & \" \" & [childmake] & \" \" & [child"
                        "Type])"
        ...
        Begin PageFooter
            ...
            Begin
                ...
                Begin Label
                    ...
                    ForeColor =5855577
                    Name ="Label121"
                    Caption ="Delivery Indicator: P -Projected, A-Actual\015\012"
