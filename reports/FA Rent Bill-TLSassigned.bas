        ...
        Begin FormHeader
            ...
            Begin
                Begin TextBox
                    ...
                    FontSize =14
                    Name ="Text1"
                    ControlSource ="=\"  Rent Bill\" & \" for \" & UCase([MLNO]) & \" Schedule \" & [schno]"
                ...
                Begin TextBox
                    ...
                    TabIndex =4
                    Name ="Text168"
                    ControlSource ="=\"  for Period from \" & [BillFrom] & \" to \" & [BillTo]"
                ...
                Begin TextBox
                    ...
                    TabIndex =7
                    Name ="Text175"
                    ControlSource ="=IIf([dueonrec]=No,IIf(IsNull([billduedt]),[Billfrom],[billduedt]),\"Due on Rece"
                        "ipt\")"
                ...
                Begin TextBox
                    ...
                    ForeColor =255
                    Name ="Text194"
                    ControlSource ="=IIf(IsNull([favenorno]),Null,\"Vendor No:\")"
                ...
                Begin TextBox
                    ...
                    ForeColor =255
                    Name ="Text196"
                    ControlSource ="=IIf(IsNull([favenorno]),Null,[favenorno])"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =4
                    Name ="Text110"
                    ControlSource ="=[TaxAmt]+[unitsbillrent]+[SGrpFSLPmt]"
                    Format ="$#,##0.00;($#,##0.00)"
        ...
        Begin BreakFooter
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =1
                    Name ="Text100"
                    ControlSource ="=Sum([TaxAmt]+[unitsbillrent]+[SGrpFSLPmt])"
                    Format ="$#,##0.00;($#,##0.00)"
