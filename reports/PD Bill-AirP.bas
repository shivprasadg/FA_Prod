        ...
        Begin FormHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    Name ="Text213"
                    ControlSource ="=\"Rent Bill\" & \" for Period from \" & [billStDt] & \" thru \" & [enddate]"
                ...
                Begin TextBox
                    ...
                    TabIndex =6
                    Name ="Text58"
                    ControlSource ="=[blOCcITY] & \", \" & [bLOCST] & \" \" & Left([BlOCzIP],5) & \"-\" & Right([BlO"
                        "CzIP],4)"
        ...
        Begin BreakHeader
            ...
            Begin
                Begin TextBox
                    ...
                    FontWeight =700
                    Name ="Text108"
                    ControlSource ="=\"Group \" & [SgrpNo] & \" \" & [LocationName]"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =8
                    Name ="Text17"
                    ControlSource ="=IIf([sgrpnopd]=Yes Or [pddays]=0,0,[pddays]*[unitpdrent])"
                    Format ="$#,##0.00;($#,##0.00)"
                    GroupTable =17
                ...
                Begin TextBox
                    ...
                    TabIndex =11
                    Name ="Text20"
                    ControlSource ="=IIf([unittaxexempt]=Yes Or [sttaxtype]<>\"rr\",0,[pddays]*[unitpdrent]*[LTaxRat"
                        "e])"
                    Format ="$#,##0.00;($#,##0.00)"
                    GroupTable =17
                ...
                Begin TextBox
                    ...
                    TabIndex =4
                    Name ="Text155"
                    ControlSource ="=IIf([sgrpnopd]=True,0,[pdrent])"
                    Format ="$#,##0.00;($#,##0.00)"
                    GroupTable =17
                ...
                Begin TextBox
                    ...
                    TabIndex =5
                    Name ="Text157"
                    ControlSource ="=IIf([sgrpnopd]=True Or [pddays]=0,Null,[unitpdst])"
                    Format ="mm/dd/yy"
                    GroupTable =17
                ...
                Begin TextBox
                    ...
                    Name ="Text207"
                    ControlSource ="=IIf([unittaxexempt]=Yes Or [sttaxtype]<>\"rr\",0,[pddays]*[unitpdrent]*[LTaxRat"
                        "e])+IIf([sgrpnopd]=Yes Or [pddays]=0,0,[pddays]*[unitpdrent])"
                    Format ="$#,##0.00;($#,##0.00)"
                    GroupTable =17
        ...
        Begin BreakFooter
            ...
            Begin
                Begin TextBox
                    ...
                    TabIndex =1
                    Name ="Text27"
                    ControlSource ="=\"Total for \" & [LocationName] & \" \" & [LState] & \" (Tax Type \" & [sttaxty"
                        "pe] & \") \""
                    GroupTable =30
                ...
                Begin TextBox
                    ...
                    TabIndex =2
                    Name ="Text209"
                    ControlSource ="=Sum(IIf([unittaxexempt]=Yes Or [sttaxtype]<>\"rr\",0,[pddays]*[unitpdrent]*[LTa"
                        "xRate])+IIf([sgrpnopd]=Yes Or [pddays]=0,0,[pddays]*[unitpdrent]))"
                    Format ="$#,##0.00;($#,##0.00)"
                    GroupTable =30
        ...
        Begin BreakFooter
            ...
            Begin
                Begin TextBox
                    ...
                    FontWeight =700
                    Name ="Text103"
                    ControlSource ="=\"Total for  Group \" & [SgrpNo] & \": \""
                    GroupTable =33
        ...
        Begin FormFooter
            ...
            Begin
                ...
                Begin Label
                    ...
                    Height =375
                    Name ="Label72"
                    Caption ="Please reference Invoice Number on payment"
                ...
                Begin TextBox
                    ...
                    TabIndex =5
                    Name ="Text172"
                    ControlSource ="=IIf([dueonrec]=Yes,\"Due on receipt\",[billduedt])"
                ...
                Begin TextBox
                    ...
                    TabIndex =6
                    Name ="Text183"
                    ControlSource ="=Sum(IIf([SchFSL]=True,Null,(IIf([unittaxexempt]=Yes Or [sttaxtype]<>\"rr\",0,(["
                        "pddays]*[unitpdrent]+IIf([sgrpnoslv]=0,0,[slvdays]*[slvrent]))*[LTaxRate]))))"
                    Format ="$#,##0.00;($#,##0.00)"
                ...
                Begin TextBox
                    ...
                    TabIndex =7
                    Name ="Text201"
                    ControlSource ="=Sum(IIf([sgrpnopd]=Yes Or [pddays]=0,0,[pddays]*[unitpdrent])+IIf([sgrpnopd]=Tr"
                        "ue,0,1.33)*IIf([sgrpnopd]=True,0,[pddays]))"
                    Format ="$#,##0.00;($#,##0.00)"
                ...
                Begin TextBox
                    ...
                    Name ="Text211"
                    ControlSource ="=Sum(IIf([unittaxexempt]=Yes Or [sttaxtype]<>\"rr\",0,[pddays]*[unitpdrent]*[LTa"
                        "xRate])+IIf([sgrpnopd]=Yes Or [pddays]=0,0,[pddays]*[unitpdrent])+IIf([sgrpnopd]"
                        "=True,0,1.33)*IIf([sgrpnopd]=True,0,[pddays]))"
                    Format ="$#,##0.00;($#,##0.00)"
