...
Begin Report
    ...
    RecSrcDt = Begin
        0x5c6dec24d70be440
    End
    RecordSource ="SELECT Clients.ClientShNm, CONCESSION.CONDT, CONCESSION.CONDESC, CONCESSION.ConA"
        "mt FROM Clients INNER JOIN CONCESSION ON Clients.clientID = CONCESSION.CONCLIENT"
        "REF WHERE (((Clients.ClientShNm)<>\"demo a\" And (Clients.ClientShNm)<>\"demo b\""
        " And (Clients.ClientShNm)<>\"demo c\" And (Clients.ClientShNm)<>\"demo d\" And ("
        "Clients.ClientShNm)<>\"demo e\" And (Clients.ClientShNm)<>\"demo f\" And (Client"
        "s.ClientShNm)<>\"demo g\" And (Clients.ClientShNm)<>\"demo h\" And (Clients.Clie"
        "ntShNm)<>\"demo i\" And (Clients.ClientShNm)<>\"demo j\")) ORDER BY Clients.Clie"
        "ntShNm, CONCESSION.CONDT DESC;"
        ...
        Begin FormHeader
            ...
            Begin
                Begin TextBox
                    ...
                    ForeColor =10040064
                    Name ="Text7"
                    ControlSource ="=UCase(\"VALUE ADDED ACTIVITIES \")"
