...
Begin Report
    ...
    RecSrcDt = Begin
        0x820b29f8f8d7e340
    End
    RecordSource ="SELECT Salesperson.SPInitials, TempLONt.noteDateTime, TempLONt.ClientShNm, nz([c"
        "lientshnm],1) AS ck, IIf([ck]=[clientshnm],\"1\",\"2\") AS srt, IIf([ck]=[client"
        "shnm],DatePart(\"m\",[NOTEDATETIME]) & \"/\" & DatePart(\"d\",[NOTEDATETIME]),Nu"
        "ll) AS RPTDT, TempLONt.SD, TempLONt.ED FROM Salesperson LEFT JOIN TempLONt ON Sa"
        "lesperson.SalespersonID = TempLONt.SalespersonREF WHERE (((Salesperson.SPInitial"
        "s)<>\"pg\")) ORDER BY Salesperson.SPInitials;"
        ...
        Begin FormHeader
            ...
            Begin
                Begin TextBox
                    ...
                    FontSize =14
                    Name ="Text42"
                    ControlSource ="=\"LO Exec Notes Review For the Period \""
                ...
                Begin TextBox
                    ...
                    TabIndex =1
                    Name ="Text51"
                    ControlSource ="=\"from \" & [Forms]![ntrevrpt]![sun] & \" to \" & [Forms]![ntrevrpt]![sat]"
        ...
        Begin BreakHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =1
                    Name ="Text19"
                    ControlSource ="=Count([clientshnm])"
        ...
        Begin BreakHeader
            ...
            Begin
                Begin TextBox
                    ...
                    Height =315
                    Name ="Text33"
                    ControlSource ="=IIf([SRT]=1,[RPTDT],\"None\") & \" \" & IIf([SRT]=\"1\",Left(WeekdayName(Weekda"
                        "y([notedatetime])),3),Null)"
