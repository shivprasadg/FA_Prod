...
Begin Form
    ...
    RecSrcDt = Begin
        0xfa618450957fe640
    End
    RecordSource ="RALConditions"
    Caption ="RAL Conditions"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin ComboBox
                    ...
                    ForeColor =0
                    Name ="Type"
                    ControlSource ="VechicleType"
                    RowSourceType ="Table/Query"
                    RowSource ="Direct;In-Direct"
                    ValidationRule ="Is Not Null"
                ...
                Begin ComboBox
                    ...
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT vw_Lookup_Clients.clientID, vw_Lookup_Clients.Client FROM vw_Lookup_Clien"
                        "ts ORDER BY vw_Lookup_Clients.Client;"
                    ColumnWidths ="0;1584"
                    ValidationRule ="Is Not Null"
                    ValidationText ="Unit Type is required"
                    FontName ="Segoe UI"
