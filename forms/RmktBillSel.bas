        ...
        Begin FormHeader
            ...
            Begin
                Begin Label
                    ...
                    ForeColor =16777215
                    Name ="Label0"
                    Caption ="Remarketing Buyer Billing "
        ...
        Begin Section
            ...
            Begin
                ...
                Begin ComboBox
                    ...
                    RowSource ="SELECT Clients.clientCompanyName, Clients.ClientShNm FROM Clients WHERE (((Clien"
                        "ts.clientType)=\"remarketing\") AND ((Clients.OBCDT) Is Null)) ORDER BY Clients."
                        "ClientShNm;"
                    ColumnWidths ="3600;2160"
                    Format =">"
                    OnDirty ="Refresh"
                    OnClickEmMacro = Begin
                        Version =196611
                        ...
                        Begin
                            Comment ="_AXL:<?xml version=\"1.0\" encoding=\"UTF-16\" standalone=\"no\"?>\015\012<UserI"
                                "nterfaceMacro For=\"Selbuyer\" xmlns=\"http://schemas.microsoft.com/office/acces"
                                "sservices/2009/11/application\"><Statements><Action Name=\"Requery\"/></Statemen"
                ...
                Begin CommandButton
                    ...
                    Name ="BillInfoBtn"
                    Caption ="Enter/View  Sale Purchase Order and Invoice Information"
                    OnClick ="[Event Procedure]"
                    ImageData = Begin
                        0x00000000
                    End
                ...
                Begin CommandButton
                    ...
                    ForeColor =-2147483615
                    Name ="BillLog"
                    Caption ="Print Remarketing Billing Log"
                    OnClick ="[Event Procedure]"
                    ImageData = Begin
                        0x00000000
                    End
                ...
                Begin CommandButton
                    ...
                    PictureData = Begin
                        ...
                        0x7272727272727272000000000000000000000000000000000000000000000000 ,
