        ...
        Begin Section
            ...
            Begin
                ...
                Begin Subform
                    ...
                    Height =3888
                    TabIndex =2
                    Name ="Tax_CityExceptionsSub"
                    SourceObject ="Form.Tax_Any_ExceptionsSub"
                    LinkChildFields ="TaxCitiesID"
                    LinkMasterFields ="CityID"
                    HorizontalAnchor =2
                    VerticalAnchor =2

                    LayoutCachedLeft =180
                    LayoutCachedTop =5058
                    LayoutCachedWidth =17250
                    LayoutCachedHeight =8946
                End
                Begin Label
                    OverlapFlags =93
                    Left =180
                    ...
                    ForeColor =8210719
                    Name ="StateLabel4"
                    Caption ="City Exceptions"
                    FontName ="Segoe UI"
                    LayoutCachedLeft =180
                    LayoutCachedTop =4669
                    LayoutCachedWidth =12960
                    LayoutCachedHeight =5058
                End
                Begin ComboBox
                    OverlapFlags =215
                    TextAlign =1
                    ...
                    RowSource ="SELECT TaxCountries.ISOCode2, TaxCountries.CountryName, TaxCountries.ISOCode3, T"
                        "axCountries.ISONumber FROM TaxCountries;"
                    ColumnWidths ="432;1440;0;0;0"
                    ValidationRule ="Is Not Null"
                    FontName ="Segoe UI"
                    ControlTipText ="Select a Country from the List"
                    AllowValueListEdits =0
                    InheritValueList =0

                    LayoutCachedLeft =1305
                    LayoutCachedTop =75
                    LayoutCachedWidth =2356
                ...
                Begin ComboBox
                    ...
                    FontName ="Segoe UI"
                    OnClick ="[Event Procedure]"
                    ControlTipText ="Select a State from the List"
                    AllowValueListEdits =0
                    InheritValueList =0
                ...
                Begin ComboBox
                    ...
                    Name ="SelectCity"
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT TaxCities.ID, [CityName] & ' (' & [CountyName] & ')' AS City2, TaxCities."
                        "TaxCountyID, TaxCounties.TaxStatesID FROM (TaxCities INNER JOIN TaxCounties ON T"
                        "axCities.TaxCountyID = TaxCounties.ID) INNER JOIN TaxStates ON TaxCounties.TaxSt"
                        "atesID = TaxStates.ID WHERE TaxCities.TaxCountyID =210 ORDER BY [CityName] & ' ("
                        "' & [CountyName] & ')';"
                    ColumnWidths ="0;4320;0;0;0"
                    ValidationText ="A City Is Required"
                    FontName ="Segoe UI"
                    OnClick ="[Event Procedure]"
                    ControlTipText ="Select a City from the list"
                    AllowValueListEdits =0
                    InheritValueList =0
