...
Begin Form
    ...
    RecordSource ="SELECT EXP.ID, EXP.ExceptionDescription, EXP.TaxRule, EXP.TaxRate, EXP.FormURL1,"
        ...
        "ermExceedsMonths, EXP.ForHireOnly, EXP.StartsOn, EXP.EndsOn, EXP.TaxCitiesID, EX"
        ...
        ", EXP.TaxMaxValue FROM TaxCitiesExceptions AS EXP LEFT JOIN TaxType ON EXP.TaxTy"
        "peID = TaxType.Id;"
