...
Begin Form
    ...
    RecSrcDt = Begin
        0x654f9f236f0ae440
    End
    RecordSource ="SELECT CONCESSION.* FROM CONCESSION ORDER BY CONCESSION.CONDT DESC;"
    Caption ="notes"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin ComboBox
                    ...
                    ValidationRule ="Is Not Null"
                    ValidationText ="Value Added Type is required"
                    FontName ="Segoe UI"
                    GroupTable =2
                    LeftPadding =0
                    TopPadding =0
