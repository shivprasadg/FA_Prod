...
Begin Form
    ...
    RecordSource ="SELECT EXP.ID, EXP.ExceptionDescription, EXP.TaxRule, EXP.TaxRate, EXP.FormURL1,"
        ...
        "ermExceedsMonths, EXP.ForHireOnly, EXP.StartsOn, EXP.EndsOn, EXP.TaxStatesID, EX"
        ...
        ", EXP.TaxMaxValue FROM TaxStatesExceptions AS EXP LEFT JOIN TaxType ON EXP.TaxTy"
        "peID = TaxType.Id;"
        ...
        Begin FormHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    ForeColor =0
                    Name ="StateNameLabel"
                    ControlSource ="=\"Exception to: \" & [TaxAbbreviation] & \" Tax \""
                    LeftPadding =0
                    RightPadding =0
...
End
CodeBehindForm
' See "Tax_StateExceptionsSub.cls"
