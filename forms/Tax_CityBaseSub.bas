...
Begin Form
    ...
    RecSrcDt = Begin
        0x0b831f52cef8e440
    End
    RecordSource ="SELECT TaxCitiesBase.id, TaxCitiesBase.TaxCityID, TaxCities.TaxCountyId, TaxCiti"
        "esBase.TaxRule, TaxCitiesBase.TaxTypeId, TaxCitiesBase.BaseTaxRate, TaxCitiesBas"
        "e.StartsOn, TaxCitiesBase.EndsOn, IIf(Not IsNull([StartsOn]) And IsNull([EndsOn]"
        "),-1,0) AS IsActive, TaxCities.CityName, TaxType.TaxFullName, TaxType.TaxAbbrevi"
        "ation, TaxType.TaxDescription FROM (TaxCitiesBase INNER JOIN TaxCities ON TaxCit"
        "iesBase.TaxCityId = TaxCities.Id) INNER JOIN TaxType ON TaxCitiesBase.TaxTypeId "
        "= TaxType.Id;"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin CommandButton
                    ...
                    ControlTipText ="Edit This Base Tax"
                    TopPadding =0
                    BottomPadding =0
                    GridlineColor =0
                    ImageData = Begin
